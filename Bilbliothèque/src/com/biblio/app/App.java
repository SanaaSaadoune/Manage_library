...
public class App {
	...
	public static void main(String[] args) {
		...
		Employee employee1 = new Employee("Saadoune", "Sanaa", 20, 45000);
		Employee employee2 = new Employee("Smir", "Safae", 20, 18998);
		Employee employee3 = new Employee("Seqi", "Salma", 20, 27383);
